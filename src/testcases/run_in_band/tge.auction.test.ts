    ...
    describe('by cmInstantiator', () => {
      ...
      describe('funds flow', () => {
        ...
        it('lp tokens staked in generator', async () => {
          // expect staked LP amount to decrease on amount of withdrawn tokens
          expect(
        ...
        it('no ntrn received by the user', async () => {
          // all ntrn rewards are transferred to the used during migration, so no additional
      ...
      describe('Migration of lp vesting', () => {
        ...
        it('save old pairs', async () => {
          tgeMain.old_pairs = tgeMain.pairs;
        });
        ...
        it('should claim', async () => {
          const vs = await neutronChain.queryContract(usdcVestingLpAddr, {
            vesting_state: {},
          });
          console.log(tgeWallets['auctionVesting'].wallet.address.toString());
          console.log(vs);
          // const vi = await neutronChain.queryContract(
          //   usdcVestingLpAddr,
          //   {
          //     vesting_accounts: {
          //     },
