...
//       const queryId = 2;
//       const res = await gaiaWallet.msgSend(
...
//
//       const balances = await neutronClient.queryBalances(contractAddress);
//       expect(balances[0].amount).toEqual('1000000');
//     });
//
...
//       );
//
//       const infos = await getCosmosSigningInfosResult(gaiaClient.);
