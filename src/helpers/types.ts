...
export const NeutronContract = {
  ...
  DAO_CORE: 'neutron_core.wasm',
  DAO_PROPOSE_SINGLE: 'cwd_propose_single.wasm',
  DAO_PROPOSE_MULTI: 'cwd_propose_multi.wasm',
  DAO_PROPOSE_OVERRULE: 'cwd_propose_overrule.wasm',
  DAO_PREPROPOSE_SINGLE: 'cwd_pre_propose_single.wasm',
  DAO_PREPROPOSE_MULTI: 'cwd_pre_propose_multi.wasm',
  DAO_PREPROPOSE_OVERRULE: 'cwd_pre_propose_overrule.wasm',
  DAO_VOTING_SINGLE: 'cwd_voting_single.wasm',
